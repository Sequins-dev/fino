...
| `12.1.1` | Removed with Autobahn group `12.*` from the initial lane. | Identify whether this is mass/performance-only or a required protocol behavior; re-enable if it is required coverage. |
| `12.1.2` | Removed with Autobahn group `12.*` from the initial lane. | Identify whether this is mass/performance-only or a required protocol behavior; re-enable if it is required coverage. |
| `13.1.1` | Removed with Autobahn group `13.*` from the initial lane. | Identify whether this is report/performance-only or a required protocol behavior; re-enable if it is required coverage. |
| `13.2.1` | Removed with Autobahn group `13.*` from the initial lane. | Identify whether this is report/performance-only or a required protocol behavior; re-enable if it is required coverage. |
| `13.3.1` | Removed with Autobahn group `13.*` from the initial lane. | Identify whether this is report/performance-only or a required protocol behavior; re-enable if it is required coverage. |
