...
bench('Context.runWithValue()', (b) => {
  ...
  b.measure('sync, nested same ctx', () =>
    ctx1.runWithValue(1, () => ctx1.runWithValue(2, () => ctx1.get())),
  );
  b.measure('no-op (undefined)', () => ctx1.runWithValue(undefined, () => {}));
});
bench('Context.runClear()', (b) => {
  b.measure('runClear clears value', () =>
    ctx1.runWithValue(42, () => ctx1.runClear(() => ctx1.get())),
  );
...
bench('snapshotAll()', (b) => {
  ...
  b.measure('two contexts set', () =>
    ctx1.runWithValue(1, () => ctx2.runWithValue(2, () => snapshotAll())),
  );
});
bench('Snapshot.runWithValue()', (b) => {
  ...
  b.measure('run with snapshot + nesting', () =>
    oneCtxSnap.runWithValue(() => ctx1.runWithValue(99, () => ctx1.get())),
  );
});
