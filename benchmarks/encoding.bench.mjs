/**
 * Benchmarks for surge:encoding
 *
 * Run with: cargo run -- --bench benchmarks/encoding.bench.mjs
 */

import { encodeUtf8, decodeUtf8, TextEncoder, TextDecoder, btoa, atob, structuredClone } from 'surge:encoding';
...
const MIXED        = 'Hello \u00e9\u00e8\u4e16\u754c\ud83d\ude00'.repeat(50);
