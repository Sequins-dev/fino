...
bench('Headers', (b) => {
  ...
  b.group('iteration', (g) => {
    ...
    g.measure('for-of 5',  () => { for (const [k, v] of h5) { /* noop */ } });
    g.measure('for-of 10', () => { for (const [k, v] of h10) { /* noop */ } });
    g.measure('keys()',    () => { for (const k of h5.keys()) { /* noop */ } });
    g.measure('values()',  () => { for (const v of h5.values()) { /* noop */ } });
  });
});
