...
*
* Run with: cargo run -- bench benchmarks/format/typescript.bench.ts
*/
import { parse, transpile } from 'fino:format/typescript';
import { bench } from 'fino:bench';
const typescript = ['export interface User { name: string; active?: boolean }', 'export const user: User = { name: "fino", active: true };'].join('\n');
