 ...
 *
 * Run with: cargo run -- bench benchmarks/opentelemetry/logs.bench.mts
 */
...
bench('opentelemetry/logs', (b) => {
  ...
  b.measure('LogRecordBuilder chain', () => new LogRecordBuilder()
    .setSeverity('WARN', SeverityNumber.WARN)
    .setTextBody('slow path')
    .setAttributes({ route: '/orders' }));
