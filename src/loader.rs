...
static BUILTINS: &[BuiltinEntry] = &[
    ...
    source_builtin!("internal:sim/io", "internal/sim/io"),
    source_builtin!("internal:sim/readiness", "internal/sim/readiness"),
    ...
    source_builtin!("internal:runtime/readiness", "internal/runtime/readiness"),
    source_builtin!("internal:io", "internal/io"),
    source_builtin!("internal:io/file", "internal/io/file"),
    source_builtin!("internal:io/watch", "internal/io/watch"),
    source_builtin!("internal:io/stream", "internal/io/stream"),
    source_builtin!("internal:io/socket", "internal/io/socket"),
    source_builtin!("internal:io/terminal", "internal/io/terminal"),
    source_builtin!("internal:io/terminalMode", "internal/io/terminalMode"),
    source_builtin!("internal:io/cwd", "internal/io/cwd"),
    source_builtin!("internal:io/process", "internal/io/process"),
    source_builtin!("internal:io/spawn", "internal/io/spawn"),
    source_builtin!("internal:io/capture", "internal/io/capture"),
    source_builtin!("internal:io/output", "internal/io/output"),
    source_builtin!("internal:io/security", "internal/io/security"),
    ...
    source_builtin!("internal:ui/preview-tui", "internal/ui/preview-tui"),
    source_builtin!("internal:ui/preview-html", "internal/ui/preview-html"),
    ...
    source_builtin!("internal:kernel/ir", "internal/kernel/ir/index"),
    source_builtin!("internal:kernel/ir/types", "internal/kernel/ir/types"),
    source_builtin!("internal:kernel/ir/builder", "internal/kernel/ir/builder"),
    source_builtin!("internal:kernel/ir/typing", "internal/kernel/ir/typing"),
    source_builtin!("internal:kernel/ir/validate", "internal/kernel/ir/validate"),
