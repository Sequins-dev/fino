...
static BUILTINS: &[BuiltinEntry] = &[
    ...
    source_builtin!("internal:sim/config", "internal/sim/config"),
    source_builtin!("internal:sim/clock", "internal/sim/clock"),
    source_builtin!("internal:sim/random", "internal/sim/random"),
    source_builtin!("internal:sim/timers", "internal/sim/timers"),
    source_builtin!("internal:sim/install", "internal/sim/install"),
