...
export class Assert {
  ...
  */
  constructor({ onPass, onFail }: AssertCallbacks = {}) {
    ...
    this.#onFail = onFail || function defaultFail(err) {
      throw err;
    };
  }
  /**
  ...
  */
  #fail(message: string, actual: unknown, expected: unknown, operator: string): void {
    this.#onFail(new AssertionError({
      message,
      actual,
      expected,
      operator
  ...
  */
  ok(value: unknown, msg?: string): void {
    if (value) {
      ...
      this.#fail((msg || 'ok') + ': expected truthy, got ' + _fmt(value), value, true, 'ok');
    }
  }
  /**
  ...
  */
  notOk(value: unknown, msg?: string): void {
    if (!value) {
      ...
      this.#fail((msg || 'notOk') + ': expected falsy, got ' + _fmt(value), value, false, 'notOk');
    }
  }
  /**
  ...
  */
  equal(actual: unknown, expected: unknown, msg?: string): void {
    if (actual === expected) {
      ...
      this.#fail((msg || 'equal') + ': expected ' + _fmt(expected) + ', got ' + _fmt(actual), actual, expected, 'equal');
    }
  }
  /**
  ...
  */
  notEqual(actual: unknown, expected: unknown, msg?: string): void {
    if (actual !== expected) {
      ...
      this.#fail((msg || 'notEqual') + ': expected !== ' + _fmt(expected) + ', but got the same value', actual, expected, 'notEqual');
    }
  }
  /**
  * Assert strict equality using `===`.
  ...
  */
  strictEqual(actual: unknown, expected: unknown, msg?: string): void {
    if (actual === expected) {
      ...
      this.#fail((msg || 'strictEqual') + ': expected ' + _fmt(expected) + ', got ' + _fmt(actual), actual, expected, 'strictEqual');
    }
  }
  /**
  * Assert strict inequality using `!==`.
  ...
  */
  notStrictEqual(actual: unknown, expected: unknown, msg?: string): void {
    if (actual !== expected) {
      ...
      this.#fail((msg || 'notStrictEqual') + ': expected !== ' + _fmt(expected) + ', but got the same value', actual, expected, 'notStrictEqual');
    }
  }
  /**
  ...
  */
  deepEqual(actual: unknown, expected: unknown, msg?: string): void {
    if (_deepEqual(actual, expected)) {
      ...
      this.#fail((msg || 'deepEqual') + ': expected ' + _fmt(expected) + ', got ' + _fmt(actual), actual, expected, 'deepEqual');
    }
  }
  /**
  ...
  */
  match(actual: string, expected: RegExp, msg?: string): void {
    ...
    if (expected.test(value)) {
      ...
      this.#fail((msg || 'match') + ': expected ' + _fmt(value) + ' to match ' + String(expected), actual, expected, 'match');
    }
  }
  /**
  ...
  */
  throws(fn: () => void, check?: ErrorCheck, msg?: string): void {
    ...
    if (!threw) {
      this.#fail((msg || 'throws') + ': expected an exception to be thrown', undefined, undefined, 'throws');
      return;
    }
    if (check && !_checkErr(thrownErr, check)) {
      this.#fail((msg || 'throws') + ': thrown value did not satisfy check: ' + _fmt(thrownErr), thrownErr, check, 'throws');
      return;
    }
    this.#pass();
  }
  ...
  */
  doesNotThrow(fn: () => void, check?: ErrorCheck, msg?: string): void {
    try {
      ...
      this.#fail((msg || 'doesNotThrow') + ': expected no exception, got ' + _fmt(err), err, check, 'doesNotThrow');
      return;
    }
    this.#pass();
  }
  ...
  */
  async rejects(fn: () => Promise<unknown>, check?: ErrorCheck, msg?: string): Promise<void> {
    ...
    if (!rejected) {
      this.#fail((msg || 'rejects') + ': expected a rejection but promise resolved', undefined, undefined, 'rejects');
      return;
    }
    if (check && !_checkErr(rejectedWith, check)) {
      this.#fail((msg || 'rejects') + ': rejection did not satisfy check: ' + _fmt(rejectedWith), rejectedWith, check, 'rejects');
      return;
    }
    this.#pass();
  }
  ...
  */
  async doesNotReject(fn: () => Promise<unknown>, check?: ErrorCheck, msg?: string): Promise<void> {
    try {
      ...
      this.#fail((msg || 'doesNotReject') + ': expected no rejection, got ' + _fmt(err), err, check, 'doesNotReject');
      return;
    }
    this.#pass();
  }
