...
export const equal = (actual: unknown, expected: unknown, msg?: string): void =>
  _default.equal(actual, expected, msg);
/**
...
export const notEqual = (actual: unknown, expected: unknown, msg?: string): void =>
  _default.notEqual(actual, expected, msg);
/**
 * Assert strict equality using the default `Assert` instance.
 *
 * ```ts no_run
...
export const strictEqual = (actual: unknown, expected: unknown, msg?: string): void =>
  _default.strictEqual(actual, expected, msg);
/**
 * Assert strict inequality using the default `Assert` instance.
 *
 * ```ts no_run
 ...
 * ```
 */
export const notStrictEqual = (actual: unknown, expected: unknown, msg?: string): void =>
  _default.notStrictEqual(actual, expected, msg);
/**
...
export const deepEqual = (actual: unknown, expected: unknown, msg?: string): void =>
  _default.deepEqual(actual, expected, msg);
/**
 ...
 * ```
 */
export const match = (actual: string, expected: RegExp, msg?: string): void =>
  _default.match(actual, expected, msg);
/**
 ...
 * ```
 */
export const throws = (fn: () => void, check?: ErrorCheck, msg?: string): void =>
  _default.throws(fn, check, msg);
/**
 ...
 * ```
 */
export const doesNotThrow = (fn: () => void, check?: ErrorCheck, msg?: string): void =>
  _default.doesNotThrow(fn, check, msg);
/**
...
export const rejects = (
  ...
  check?: ErrorCheck,
  msg?: string,
): Promise<void> => _default.rejects(fn, check, msg);
/**
 ...
 * ```
 */
export const doesNotReject = (
  fn: () => Promise<unknown>,
  check?: ErrorCheck,
  msg?: string,
): Promise<void> => _default.doesNotReject(fn, check, msg);
