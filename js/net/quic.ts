...
* ```
*/
export { CidRoutingTable, QuicConnection, QuicConnectionEvent, QuicDatagramEvent, QuicDatagramStatusEvent, QuicEarlyDataEvent, QuicEndpoint, QuicErrorEvent, QuicVersionNegotiationError, QuicListener, QuicNewTokenEvent, QuicPathValidationEvent, QuicStream, QuicStreamBlockedEvent, QuicStreamResetEvent, QuicStreamEvent, QuicStopSendingEvent, __inspectQuicCallbackTable, __inspectQuicRuntimeTuning, cryptoBackend, quicAvailable, quicResetStreamAtAvailable, quicVersion, requireQuic, type QuicAddress, type QuicConnectOptions, type QuicConnectionOptions, type QuicConnectionStats, type QuicConnectionState, type QuicDatagramOptions, type QuicDatagramStatus, type QuicEarlyDataPolicy, type QuicEndpointOptions, type QuicEndpointStats, type QuicKeylogOptions, type QuicListenOptions, type QuicMigrationOptions, type QuicPath, type QuicPathValidationResult, type QuicQlogOptions, type QuicRateLimitOptions, type QuicResolvedRateLimitOptions, type QuicResolvedConnectionOptions, type QuicResolvedSourceAddressOptions, type QuicResolvedTransportOptions, type QuicRetryOptions, type QuicSessionState, type QuicSNIContextOptions, type QuicSessionStore, type QuicSourceAddressOptions, type QuicStreamStats, type QuicTlsCipherSuite, type QuicTransportOptions, type QuicTransportParameterSnapshot, type QuicVersion } from '../internal/net/quic/endpoint.ts';
