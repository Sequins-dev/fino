...
// Helpers
// ---------------------------------------------------------------------------
function normalizeOptions(options: boolean | AddEventListenerOptions | null | undefined): {
  capture: boolean;
  once: boolean;
  passive: boolean;
} {
...
Object.defineProperty(Event.prototype, 'cancelBubble', {
  get() {
    return _eventState.get(this as Event)!.stopPropagation;
  },
  set(v) {
...
Object.defineProperty(Event.prototype, 'returnValue', {
  get() {
    return !_eventState.get(this as Event)!.defaultPrevented;
  },
  set(v) {
