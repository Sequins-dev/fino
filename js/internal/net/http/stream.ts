...
*/
export type HttpStreamErrorCode = 'cancelled' | 'closed' | 'flow-control' | 'goaway' | 'protocol' | 'refused' | 'shutdown' | 'transport';
/**
...
export class HttpStreamError extends Error {
  ...
  * `null`.
  */
  constructor(code: HttpStreamErrorCode, message: string, options: {
