...
export type QuicDatagramPacketCallback = (data: Uint8Array, addr: QuicAddress | undefined, ecn: number | undefined, path: QuicDatagramPathMetadata | undefined) => void;
/**
...
export function normalizeSocketOptionInteger(input: number | undefined, min: number, max: number, name: string): number | undefined {
...
export function normalizeSocketOptions(input: QuicSocketOptions | undefined): Required<Pick<QuicSocketOptions, never>> & QuicSocketOptions {
...
export function normalizeDatagramSource(data: QuicDatagramBytes, encoding: QuicDatagramEncoding): Uint8Array {
...
export function normalizeVersions(input: QuicVersion[] | undefined, base?: ResolvedQuicOptions): QuicVersion[] {
...
export function normalizeTlsCipherSuites(input: QuicTlsCipherSuite[] | undefined, base?: ResolvedQuicOptions): QuicTlsCipherSuite[] | null {
...
export function normalizeTlsGroups(input: string[] | undefined, base?: ResolvedQuicOptions): string[] | null {
...
export function normalizeRetry(input: QuicRetryOptions | undefined, base?: ResolvedQuicOptions): ResolvedRetryOptions {
...
export function normalizeDatagrams(input: QuicDatagramOptions | undefined, base?: ResolvedQuicOptions): ResolvedDatagramOptions {
  if (input === undefined) {
...
export function normalizePreferredAddress(input: QuicPreferredAddressOptions | undefined): ResolvedPreferredAddressOptions | undefined {
  if (input === undefined) return undefined;
  if ('family' in input) {
...
export function normalizeMigration(input: QuicMigrationOptions | undefined, base?: ResolvedQuicOptions): ResolvedMigrationOptions {
...
export function normalizeQlog(input: QuicQlogOptions | undefined, base?: ResolvedQuicOptions): QuicQlogOptions {
...
export function normalizeKeylog(input: QuicKeylogOptions | undefined, base?: ResolvedQuicOptions): QuicKeylogOptions {
...
export function normalizeRateLimit(input: QuicRateLimitOptions | undefined, base: ResolvedRateLimitOptions | undefined, defaults: ResolvedRateLimitOptions, name: string): ResolvedRateLimitOptions {
...
export function normalizeLimit(input: number | undefined, base: number | undefined, defaults: number, name: string): number {
...
export function normalizeTimeoutMs(input: number | undefined, base: bigint | undefined, defaults: bigint, min: bigint, max: bigint, name: string): bigint {
...
export function normalizeDurationMs(input: number | undefined, base: bigint | undefined, defaults: bigint, name: string): bigint {
  if (input === undefined) return base ?? defaults;
  if (!Number.isFinite(input) || input < 0) throw new TypeError(`QUIC ${name} must be a non-negative number of milliseconds`);
  return BigInt(Math.floor(input * 1e6));
}
export function normalizeInteger(input: number | undefined, base: number | undefined, defaults: number, min: number, max: number, name: string): number {
  const value = input ?? base ?? defaults;
...
export function normalizeClampedInteger(input: number | undefined, base: number | undefined, defaults: number, min: number, max: number, name: string): number {
  const value = input ?? base ?? defaults;
...
export function normalizeTransportVarint(input: number | undefined, base: bigint | undefined, defaults: bigint, name: string): bigint {
  if (input === undefined) return base ?? defaults;
  if (!Number.isInteger(input) || input < 0) throw new TypeError(`QUIC ${name} must be a non-negative integer`);
  return BigInt(input);
}
export function normalizeConnection(input: QuicConnectionOptions | undefined, base?: ResolvedQuicOptions): ResolvedConnectionOptions {
...
export function normalizeTransport(input: QuicTransportOptions | undefined, base?: ResolvedQuicOptions): ResolvedTransportOptions {
...
export function resolveQuicOptions(options: QuicEndpointOptions | QuicListenOptions | QuicConnectOptions = {}, base?: ResolvedQuicOptions): ResolvedQuicOptions {
...
export function freezeRateLimitSnapshot(input: ResolvedRateLimitOptions): QuicResolvedRateLimitOptions {
  return Object.freeze({
    rate: input.rate,
    burst: input.burst
  });
}
export function freezeTransportSnapshot(input: ResolvedTransportOptions): QuicResolvedTransportOptions {
  return Object.freeze({
    busy: input.busy,
...
export function freezeConnectionSnapshot(input: ResolvedConnectionOptions): QuicResolvedConnectionOptions {
  return Object.freeze({
...
export function generateRegularToken(secret: Uint8Array, remoteAddress: QuicAddress, runtime: QuicRuntime): Uint8Array | null {
...
export function verifyRegularToken(secret: Uint8Array, remoteAddress: QuicAddress, token: Uint8Array, runtime: QuicRuntime, timeout: bigint = REGULAR_TOKEN_TIMEOUT): boolean {
  const remote = encodeAddr(remoteAddress);
...
export function readPacketVarint(packet: Uint8Array, offset: number): {
  value: number;
  offset: number;
} | null {
...
export function makePath(localAddress: QuicAddress, remoteAddress: QuicAddress, fd = 0): NativePath {
...
export function makePathFromSockaddrs(localSockaddr: ArrayBuffer, localSockaddrLen: number, remoteSockaddr: ArrayBuffer, remoteSockaddrLen: number, fd = 0): NativePath | null {
...
export function makeOutputPath(localAddress: QuicAddress, remoteAddress: QuicAddress, fd = 0): NativePath {
...
export function pathSnapshotFromNative(path: ArrayBuffer | null, fallbackFd: number): PathSnapshot | null {
...
export function preferredAddressFromNative(paddr: ArrayBuffer | null, family: 'ipv4' | 'ipv6'): QuicAddress | null {
...
export function cidFromTransportParams(params: ArrayBuffer, offset: number, presentOffset: number): Uint8Array | null {
...
export function transportParameterSnapshot(params: ArrayBuffer | null): QuicTransportParameterSnapshot | null {
...
export function writeNativePathAddress(destPath: ArrayBuffer, pathOffset: number, address: QuicAddress): boolean {
...
export function qlogOutputPath(basePath: string | undefined, connectionId: string): {
  path: string;
  directory?: string;
} {
...
export function createServerTlsContext(certificateFile: string, privateKeyFile: string, alpnProtocols: string[], options: Pick<ResolvedQuicOptions, 'tlsCipherSuites' | 'tlsGroups' | 'keylog'>, tlsOptions: {
  clientAuth?: 'none' | 'request' | 'require';
  verifyClient?: boolean;
  rejectUnauthorized?: boolean;
  ca?: QuicCaOptions;
...
export function qlogWriteCallbackPointer(): ArrayBuffer {
  if (_qlogWriteCallback === null) {
    _qlogWriteCallback = new FfiCallback({
      ...
      connectionFromUserData(userData)?.[quicConnectionInternals.onQlogWrite](flags, copyFromPtr(data, Number(datalen)));
    }));
...
export function makeSettings(options: ResolvedQuicOptions, runtime: QuicRuntime, token: Uint8Array | null = null, tokenType = NGTCP2_TOKEN_TYPE_UNKNOWN, originalVersion = 0): ArrayBuffer {
...
export function makeTransportParams(originalDcid: ArrayBuffer | null = null, options?: ResolvedQuicOptions, retryScid: ArrayBuffer | null = null, preferredAddress?: PreferredAddressParams | null, statelessResetToken?: Uint8Array | null): ArrayBuffer {
...
export function ensureCallbackTable(): ArrayBuffer {
  ...
  const recvStreamData = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onStreamData](Number(streamId), Number(offset), copyFromPtr(data, Number(datalen)), (flags & STREAM_DATA_FLAG_FIN) !== 0);
    return 0;
  }));
  const recvDatagram = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onDatagram](copyFromPtr(data, Number(datalen)), (flags & NGTCP2_DATAGRAM_FLAG_0RTT) !== 0);
    return 0;
  }));
  const streamOpen = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onRemoteStreamOpen](Number(streamId));
    return 0;
  }));
  ...
  const streamReset = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onStreamReset](Number(streamId), Number(appCode));
    return 0;
  }));
  const acked = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onAckedStreamDataOffset](Number(streamId), Number(offset), Number(datalen));
    return 0;
  }));
  const extendStreamsBidi = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onLocalStreamCredit]('bidirectional');
    return 0;
  }));
  const extendStreamsUni = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onLocalStreamCredit]('unidirectional');
    return 0;
  }));
  const extendMaxStreamData = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onStreamDataCredit](Number(streamId), Number(maxData));
    return 0;
  }));
  const stopSending = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onStreamStopSending](Number(streamId), Number(appCode));
    return 0;
  }));
  ...
  const getNewConnectionId = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.registerIssuedCid](makeCid(bytes));
    return 0;
  }));
  ...
  const dcidStatus = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onDestinationCidStatus](type, cid, token);
    return 0;
  }));
  const recvNewToken = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onNewToken](copyFromPtr(token, Number(tokenlen)));
    return 0;
  }));
  const ackDatagram = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onDatagramStatus](Number(dgramId), 'ack');
    return 0;
  }));
  const lostDatagram = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onDatagramStatus](Number(dgramId), 'lost');
    return 0;
  }));
  ...
  const recvVersionNegotiation = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onVersionNegotiation](hd, sv, Number(nsv));
    return 0;
  }));
  ...
  const beginPathValidation = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onPathValidationStarted](path, fallbackPath, flags);
    return 0;
  }));
  const pathValidation = new FfiCallback({
    ...
    connectionFromUserData(userData)?.[quicConnectionInternals.onPathValidationFinished](path, fallbackPath, result, flags);
    return 0;
  }));
  const selectPreferredAddress = new FfiCallback({
    ...
    return connectionFromUserData(userData)?.[quicConnectionInternals.selectPreferredAddress](dest, paddr) ?? 0;
  }));
...
export class QuicEndpoint extends EventTarget {
  ...
  */
  ...
  async [quicEndpointInternals.bindTransport](address: QuicAddress, options: {
    ecn?: boolean;
  } = {}): Promise<QuicDatagramTransport> {
  ...
  */
  async listen(options: QuicListenOptions = {}): Promise<QuicListener> {
    ...
    const transport = await this[quicEndpointInternals.bindTransport](input, { ecn: resolvedOptions.transport.ecn });
    ...
    try {
      ...
      if (preferredAddress !== undefined) {
        ...
        if (preferredAddress.ipv4 !== undefined) {
          const preferredTransport = await this[quicEndpointInternals.bindTransport](preferredAddress.ipv4, { ecn: resolvedOptions.transport.ecn });
          transports.push(preferredTransport);
          boundPreferred.ipv4 = preferredTransport.address;
        }
        if (preferredAddress.ipv6 !== undefined) {
          const preferredTransport = await this[quicEndpointInternals.bindTransport](preferredAddress.ipv6, { ecn: resolvedOptions.transport.ecn });
          transports.push(preferredTransport);
    ...
    const listener = new (quicListenerClass())(this, bound, protocols, transports, ctx, listenerOptions, sniContexts);
  ...
  */
  async connect(options: QuicConnectOptions): Promise<QuicConnection> {
    ...
    const transport = await this[quicEndpointInternals.bindTransport](bindAddress, { ecn: resolvedOptions.transport.ecn });
    ...
    const connection = new (quicConnectionClass())('client', this, null, local, remoteAddress, clientProtocols, transport, ctx, tls, null, resolvedOptions, serverName);
    connection[quicConnectionInternals.setSessionStoreKey](sessionKey);
    connection[quicConnectionInternals.setClientSessionOptions](options.verifyPeer === true, earlyDataMax);
    if (addressToken !== null && addressToken.byteLength > 0) {
      connection[quicConnectionInternals.setAddressValidationToken](addressToken, NGTCP2_TOKEN_TYPE_NEW_TOKEN);
    }
    connection[quicConnectionInternals.initClient](rememberedVersion);
    const earlyTransportParametersAccepted = resolvedOptions.earlyData !== false && resumedSession && sessionEarlyDataMax > 0 && rememberedTransportParameters !== undefined && connection[quicConnectionInternals.setEarlyTransportParameters](rememberedTransportParameters);
    ...
    connection[quicConnectionInternals.setEarlyDataReady](earlyDataReady, Math.min(earlyDataMax, sessionEarlyDataMax));
    ...
    if (earlyDataRejectReason !== null) {
      ...
      this.#runtime.setTimer(0, () => connection[quicConnectionInternals.scheduleEarlyDataEvent](false, reason));
    }
    if (!clientProtocols.includes(connection.alpnProtocol)) {
  ...
  */
  ...
  [quicEndpointInternals.track](connection: QuicConnection): void {
    ...
    if (connection[quicConnectionInternals.roleForStats]() === 'server') this.#stats.serverConnections++;
    else this.#stats.clientConnections++;
    publishQuicTopic(connection[quicConnectionInternals.roleForStats]() === 'server' ? 'quic.session.created.server' : 'quic.session.created.client', {
      endpoint: this,
      connection,
    ...
    connection.addEventListener('close', () => {
      ...
      if (this.#closed) {
        ...
        timer = this.#runtime.setTimer(connection[quicConnectionInternals.drainingRetentionMsForRouting](), untrack);
  ...
  [quicEndpointInternals.registerStatelessResetToken](token: string, connection: QuicConnection): void {
    this.#statelessResetTokens.set(token, connection);
  }
  [quicEndpointInternals.unregisterStatelessResetToken](token: string, connection: QuicConnection): void {
  ...
  #activeServerConnectionCount(listener?: QuicListener, remoteAddress?: QuicAddress, excluding?: QuicConnection): number {
    ...
    for (const connection of this.#connections) {
      ...
      if (connection[quicConnectionInternals.matchesServerConnection](listener, remoteAddress)) count++;
    }
    return count;
  }
  ...
  #connectingServerConnection(listener: QuicListener, remoteAddress: QuicAddress): QuicConnection | null {
    ...
    for (const connection of this.#connections) {
      if (connection.state !== 'connecting' || !connection[quicConnectionInternals.matchesServerConnection](listener, remoteAddress) || connection.remoteAddress.port !== remoteAddress.port) continue;
  ...
  [quicEndpointInternals.handleDatagram](listener: QuicListener | null, transportOrFd: QuicDatagramTransport | number, localAddress: QuicAddress, packet: Uint8Array, remoteAddress: QuicAddress | undefined, packetEcn?: number, pathMetadata?: QuicDatagramPathMetadata): void {
    ...
    if (existing) {
      if (decodedRemoteAddress === undefined && !needsSourceAddress && existing[quicConnectionInternals.canReceiveWithoutDecodedAddress]()) {
        existing[quicConnectionInternals.receivePacket](packet, existing.remoteAddress, localAddress, transport, packetEcn, pathMetadata);
        return;
      }
      ...
      if (listener !== null && routedVersion !== 0 && (packet[0] & 64) !== 0 && existing.state === 'connecting' && existing[quicConnectionInternals.roleForStats]() === 'server' && existing[quicConnectionInternals.matchesServerConnection](listener, routedRemoteAddress) && existing[quicConnectionInternals.wireVersionForRouting]() !== routedVersion && ngtcp2Sym!.ngtcp2_is_supported_version(routedVersion) !== 0) {
      ...
      existing[quicConnectionInternals.receivePacket](packet, routedRemoteAddress, localAddress, transport, packetEcn, pathMetadata);
      return;
    }
    const routedRemoteAddress = decodeRemoteAddress();
    if (routedRemoteAddress === null) return;
    ...
    if (connecting !== null && connecting[quicConnectionInternals.wireVersionForRouting]() === version) {
      connecting[quicConnectionInternals.receivePacket](packet, routedRemoteAddress, localAddress, transport, packetEcn, pathMetadata);
      return;
    }
    const replacement = connecting !== null && connecting[quicConnectionInternals.wireVersionForRouting]() !== version ? connecting : null;
  ...
  #acceptInitial(listener: QuicListener, transport: QuicDatagramTransport, localAddress: QuicAddress, remoteAddress: QuicAddress, packet: Uint8Array, decoded: ArrayBuffer, packetEcn?: number, pathMetadata?: QuicDatagramPathMetadata): void {
    ...
    const tls = newServerSession(listener[quicListenerInternals.ctx], listener.alpnProtocols, earlyDataMax);
    const connection = new (quicConnectionClass())('server', this, listener, localAddress, remoteAddress, listener.alpnProtocols, transport, null, tls, originalDcid, listener.options);
    connection[quicConnectionInternals.initServer](clientScid, serverScid, version, retry?.retryScid ?? null, retry?.token ?? addressToken?.token ?? null, retry?.tokenType ?? addressToken?.tokenType ?? NGTCP2_TOKEN_TYPE_UNKNOWN);
    this[quicEndpointInternals.track](connection);
    const rc = connection[quicConnectionInternals.receivePacket](packet, remoteAddress, localAddress, transport, packetEcn, pathMetadata);
...
function quicListenerClass(): QuicListenerConstructor {
  if (registeredQuicListenerClass === null) throw new Error('QUIC listener class has not been registered');
  return registeredQuicListenerClass;
}
function quicConnectionClass(): QuicConnectionConstructor {
  if (registeredQuicConnectionClass === null) throw new Error('QUIC connection class has not been registered');
