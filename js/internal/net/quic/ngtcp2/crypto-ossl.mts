...
const _SYMBOLS = {
  ngtcp2_crypto_ossl_init: { parameters: [], result: 'i32' },
  ngtcp2_crypto_ossl_ctx_new: { parameters: ['pointer', 'pointer'], result: 'i32' },
  ngtcp2_crypto_ossl_ctx_del: { parameters: ['pointer'], result: 'void' },
  ngtcp2_crypto_ossl_ctx_set_ssl: { parameters: ['pointer', 'pointer'], result: 'void' },
  ngtcp2_crypto_ossl_ctx_get_ssl: { parameters: ['pointer'], result: 'pointer' },
  ngtcp2_crypto_ossl_configure_client_session: { parameters: ['pointer'], result: 'i32' },
  ngtcp2_crypto_ossl_configure_server_session: { parameters: ['pointer'], result: 'i32' },
