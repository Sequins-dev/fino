...
* @internal
*/
export function createWorkload(entryPath: string, delegatesReadiness?: boolean, processReadiness?: boolean): number;
...
/** Drive process-reactor workloads across the native worker pool. */
export function drivePooledResidentWorkloads(handles: number[], inputs: unknown[], threads?: number): unknown;
...
export function routeProcessReadiness(owner: number, ident: number, filter: number, flags: number, fflags: number, data: number, udata: number): void;
...
export function registerProcessReadiness(ident: number, filter: number, flags: number, fflags: number, data: number, udata: number): void;
