...
async function readClusterStream(stream: WebTransportBidirectionalStream, onMetadata: (metadata: ClusterStreamMetadata, writer: StreamWriter) => void | Promise<void>, onMessage: (metadata: ClusterStreamMetadata, msg: ClusterMessage) => void, onClose: (metadata: ClusterStreamMetadata | null) => void, existingWriter?: StreamWriter, initialMetadata: ClusterStreamMetadata | null = null): Promise<void> {
  ...
  async #handleSession(wt: WebTransport): Promise<void> {
    ...
    try {
      while (true) {
        ...
        void readClusterStream(stream, async (metadata, writer) => {
...
export class WebTransportWorkerTransport implements ClusterTransport {
  ...
  */
  ...
  #readStream(stream: WebTransportBidirectionalStream, writer?: StreamWriter, initialMetadata: ClusterStreamMetadata | null = null): void {
    ...
    }, () => {}, writer, initialMetadata).catch((err: unknown) => {
