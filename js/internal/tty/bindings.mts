...
const TCSANOW = 0;
const TIOCGWINSZ = os === 'darwin' ? 0x40087468 : 0x5413;

const lib = (() => {
  try {
    return dlopen(LIBC, {
      tcgetattr: { parameters: ['i32', 'buffer'], result: 'i32' },
      tcsetattr: { parameters: ['i32', 'i32', 'buffer'], result: 'i32' },
      cfmakeraw: { parameters: ['buffer'], result: 'void' },
