 ...
 * The width classes follow [Unicode Standard Annex #11: East Asian
 * Width](https://www.unicode.org/reports/tr11/), while cluster grouping is a
 * terminal-oriented subset of [Unicode Standard Annex #29: Text
 * Segmentation](https://www.unicode.org/reports/tr29/), not a complete
 * implementation of its extended grapheme cluster algorithm.
 *
 * @internal
 */
