...
import { file } from 'internal:io';
import { os } from 'internal:process';
import { usesProcessReadiness } from 'internal:runtime/readiness';
import { encodeUtf8, decodeUtf8 } from '../encoding.ts';
import { getRealmCwd } from 'internal:process/cwd';
import { Path } from '../../file/path.ts';
import { O_RDONLY, O_WRONLY, O_RDWR, O_CREAT, O_TRUNC, O_APPEND, SEEK_CUR } from './constants.ts';
