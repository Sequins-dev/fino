...
type OptionDefault = boolean | string | number | Array<string | number> | ((ctx: CommandContext) => boolean | string | number | Array<string | number> | Promise<boolean | string | number | Array<string | number>>);
