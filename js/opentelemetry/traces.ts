...
*/
export { AlwaysOnSampler, Sampler, Span, Tracer, TracerProvider, applySpanLimits, getActiveSpan, getActiveSpanContext, getTracerProvider, isScopedTraceTopic, isTracerProviderContextEnabled, runWithActiveSpan, runWithTracerProvider, runWithoutTracerProvider, setTracerProvider } from '../internal/opentelemetry/traces.ts';
export type { ActiveTelemetryContext, SamplingResult, SpanEndOptions, SpanEventRecord, SpanLimits, SpanLinkContext, SpanLinkRecord, SpanRecord, SpanStartOptions, SpanStatus, TraceContext } from '../internal/opentelemetry/common.ts';
