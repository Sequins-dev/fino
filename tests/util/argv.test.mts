/**
 * Tests for fino:util/argv — config-based nested command parsing and execution.
 */

import { describe, it } from 'fino:test/test';
import { Command, type CommandContext, type CommandInvocation } from 'fino:util/argv';
