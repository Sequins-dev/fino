...
describe('internal:globals/global registry', () => {
  ...
  it('aliases self to globalThis and exposes a minimal navigator', (t) => {
    ...
    t.equal((navigator as {
      hardwareConcurrency?: unknown;
    }).hardwareConcurrency, undefined, 'navigator has no hardwareConcurrency shim');
  ...
  it('does not install Node process or browser rejection-event globals', (t) => {
    t.equal((globalThis as {
      process?: unknown;
    }).process, undefined, 'global process is intentionally absent');
    t.equal((globalThis as {
      onunhandledrejection?: unknown;
    }).onunhandledrejection, undefined, 'onunhandledrejection is not installed');
    t.equal((globalThis as {
      onrejectionhandled?: unknown;
    }).onrejectionhandled, undefined, 'onrejectionhandled is not installed');
  });
