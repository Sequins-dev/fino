...
describe('atob / btoa', () => {
  ...
  it('btoa encodes binary bytes', (t) => {
    t.equal(btoa('\0'), 'AAEC', 'binary bytes');
    t.equal(btoa('ÿþý'), '//79', 'high bytes');
  });
