...
describe('URLSearchParams construction', () => {
  ...
  it('record constructor uses USVString keys and overwrites duplicate converted names', (t) => {
    const params = new URLSearchParams({ '\uD835x': '1', xx: '2', '\uD83Dx': '3' } as any);
