...
describe('fino:ui/html', () => {
  it('serializes VNodes with escaped text, attributes, booleans, style objects, and fragments', (t) => {
    ...
    t.equal(html, '<section id="root" class="panel" disabled style="color:red;background-color:white" title="&quot;quoted&quot; &amp; &lt;tag&gt;">Hello &lt;Ada&gt;<input name="q" value="a&amp;b" checked></section>');
  });
