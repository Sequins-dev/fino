...
import { Assert, AssertionError, ok, notOk, equal, notEqual, deepEqual, fail, throws, rejects, match, doesNotThrow, doesNotReject, strictEqual, notStrictEqual } from 'fino:test/assert';
...
describe('default assert instance', () => {
  it('throws AssertionError on ok(false)', (t) => {
    t.throws(() => assertDefault.ok(false), (e) => e instanceof AssertionError, 'throws AssertionError');
  });
...
describe('throws', () => {
  ...
  it('check function validates thrown value', (t) => {
    ...
    a.throws(() => {
      throw new TypeError();
    }, (e) => e instanceof TypeError, 'right type');
    a.throws(() => {
      throw new Error();
    }, (e) => e instanceof TypeError, 'wrong type');
  ...
  it('constructor check matches thrown error type', (t) => {
    ...
    }, TypeError, 'matches constructor');
    a.throws(() => {
      throw new Error('plain');
    }, TypeError, 'wrong constructor');
    t.equal(errors.length, 1, '1 failure');
  });
