...
import { SETTINGS_ENABLE_CONNECT_PROTOCOL, SETTINGS_H3_DATAGRAM, SETTINGS_WT_ENABLED, WEBTRANSPORT_BIDI_STREAM_TYPE, WEBTRANSPORT_UNI_STREAM_TYPE, decodeHttpDatagram, decodeQuicVarint, decodeWebTransportStreamPrefix, encodeHttpDatagram, encodeQuicVarint, encodeWebTransportStreamPrefix, webTransportSettings, webTransportSettingsEnabled } from '../../js/internal/net/http/h3/webtransport.ts';
describe('WebTransport H3 framing helpers', () => {
  it('matches draft-15 SETTINGS and stream/datagram framing', (t) => {
    ...
    t.deepEqual([...encodeQuicVarint(16384n)], [
      128,
      0,
      64,
      0
    ]);
    t.deepEqual(decodeQuicVarint(new Uint8Array([
      128,
      0,
      64,
      0
